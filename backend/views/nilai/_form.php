...
<div class="tbl-nilai-form">
    <div class="box box-primary">
        ...
        'options' => ['class' => 'form-horizontal','action' => 'df'],
            ...
            <div id="div-kelas"  class="panel_a_style panel_a batas" style="display: none;">
                        <?php
            ...
            <div id="div-siswa" class="panel_a panel_a_style batas" style="display: none;">
            ...
            <div id="div-pil-nilai" class="panel_a panel_a_style batas" style="display: none;">
            ...
            <div id="div-nilai" class="panel_a panel_a_style batas" style="display: none;">
            ...
            <div class="panel_a panel_a_style batas">
                <div class="form-group">
                    ...
                    <?php echo Html::submitButton( 'Create', ['class' => 'btn btn-success','id'=>'save','style'=>'display:none']) ?>
                </div>
            </div>
        </div>
    </div>
